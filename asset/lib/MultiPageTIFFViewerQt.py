...
from RSIC.asset.lib.QtImageViewer import QtImageViewer
import tiffcapture
    ...
    def loadImageStackFromFile(self, fileName=''):
        ...
        if len(fileName) == 0:
            if QT_VERSION_STR[0] == '4':
                fileName = QFileDialog.getOpenFileName(self, "Open TIFF stack file.", r"E:\Desktop", "*.tif")
            elif QT_VERSION_STR[0] == '5':
                fileName, dummy = QFileDialog.getOpenFileName(self, "Open TIFF stack file.", r"E:\Desktop\GisFile", "*.tif")
